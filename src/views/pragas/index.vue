<template>
    <ion-page>
      ...
      <ion-content class="ion-padding">
        ...
        <ion-list v-for="item in displayList" :key="item.id">
          <ion-item>
        ...
        <praga-info :is-open="informacoes.show" :initialValues="informacoes.data" @modal-close="handleInfoClosed"/>
        <nova-praga :is-open="modalInfo.show" :initialValues="modalInfo.data" @modal-closed="handleModalClosed"/>
...
import NovaPraga from "./new.vue";
import PragaInfo from "./info.vue";
